        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-8 bg-emerald-50 rounded-[40px] space-y-4 border border-emerald-100">
              ...
              />
              <label className="block text-[10px] font-black text-emerald-900 uppercase tracking-widest mt-4">Supporting Aspirations</label>
              <textarea 
                rows={3} 
          ...
          <div className="space-y-8 pt-10 border-t border-slate-100">
            <h4 className="text-sm font-black text-slate-900 uppercase tracking-widest">Legacy & History</h4>
            <div className="bg-slate-50 p-8 rounded-[40px] space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Year Established</label>
                  <input 
                    type="number" 
                    ...
                    value={about.history.foundingStory.yearEstablished} 
                    onChange={e => updateSubField('history', 'foundingStory', { ...about.history.foundingStory, yearEstablished: parseInt(e.target.value) })} 
                  />
                </div>
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Initial Population</label>
                  <input 
                    className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 font-bold focus:ring-2 focus:ring-blue-500 outline-none transition-all" 
                    value={about.history.foundingStory.initialStudentPopulation} 
                    onChange={e => updateSubField('history', 'foundingStory', { ...about.history.foundingStory, initialStudentPopulation: e.target.value })} 
                  />
                </div>
              </div>
            </div>
